...
public abstract class Account {
     ...
     * name, 4 digit PIN, and account history. The account history for all of
     * accounts
     * starts with an entry with the date and time the account was created. When the
     * account is created, it is added to the account database.
     * 
     * @param accountName
     *                    The account holder's name.
     * @param accountPin
    ...
    /**
     * Generates a random 6 digit account number that is currently not in use by any
    ...
    /**
     * Retrieves an account from the account database with a specified account
     * number. The method also checks to make sure the correct PIN has been entered.
     * 
     * @param accountNumber
     ...
     *                                  Thrown if an account with the given account
    ...
    /**
     * Checks the account database to see if an account with the given account
     * number has been created.
     * 
     * @param accountNumber
     *                      The account number to check for.
     * @return True, if an account with the given account number has been found in
     *         the account map.
     * @throws NullPointerException
     *                              Thrown if an account with the given account
     *                              number cannot be found or does not exist.
     ...
     * @throws IllegalArgumentException
     *                                  Thrown if the current PIN is incorrect, or
